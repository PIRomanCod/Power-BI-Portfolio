# Analytic Portfolio Projects: MS Power BI, Looker, MS Fabric
...
![Looker](https://img.shields.io/badge/Looker-blue?style=for-the-badge&logo=Looker&logoColor=white)
![Fabric](https://img.shields.io/badge/fabric-green?style=for-the-badge&logo=msfabric&logoColor=white)

Welcome to my personal Analytic portfolio repository! Here you will find a collection of Power BI, Looker and Fabric projects and dashboards that demonstrate my skills and expertise in data visualization, business intelligence, and analytics using BI tools.
...
This portfolio showcases my mastery of BI and highlights my ability to effectively present complex data visually.
...
## Project 5: Hybrid Public traffic platform for Zaporizhia

<details> <summary>A platform for traffic from scratch for a single city
(Data engineering, Visualizations, Alerts)</summary>

This project was part of the Microsoft DP 700 course and certification exam

Capstone requirements:
Building an automated data collection, transformation, and enrichment system

Using batch and real-time, streaming data sources, visualisations in Real-time Dashboard with low latency

Ability to use the full set of MS Factory tools:
Lakehouse, Dataflow Gen2, Eventstream, KQL, Pipelines, Notebooks, and Power BI

The project processes static historical data and real-time IoT sensor streams, performs ETL transformations, aggregates
and enriches the data, and delivers actionable insights through realtime dashboards.

This project showcases the design and implementation of a Smart City Traffic &
Incident Platform on Microsoft Fabric, demonstrating real-time analytics, batch ETL processing,
and interactive dashboards — all within a unified platform. The solution is extensible, cloudnative, and aligned with modern data engineering best practices, making it ideal for smart city
governance, urban planning, and traffic optimization use cases.

### Orchestration

Project Lineage part 1
...
Query Set For Real-Time analytic
...
Public Transport Report Dashboard
